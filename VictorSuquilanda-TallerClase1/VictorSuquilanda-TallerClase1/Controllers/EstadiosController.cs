...
namespace VictorSuquilanda_TallerClase1.Controllers
{
    public class EstadiosController : Controller
    {
        ...
        public EstadiosController(VictorSuquilanda_TallerClase1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Direccion,Capacidad")] Estadio estadio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Direccion,Capacidad")] Estadio estadio)
        {
            if (id != estadio.Id)
            {
                return NotFound();
