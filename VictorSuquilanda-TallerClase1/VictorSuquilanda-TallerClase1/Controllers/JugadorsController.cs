...
namespace VictorSuquilanda_TallerClase1.Controllers
{
    public class JugadorsController : Controller
    {
        ...
        public JugadorsController(VictorSuquilanda_TallerClase1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Posicion,Edad,IdEquipo")] Jugador jugador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Posicion,Edad,IdEquipo")] Jugador jugador)
        {
            if (id != jugador.Id)
            {
                return NotFound();
