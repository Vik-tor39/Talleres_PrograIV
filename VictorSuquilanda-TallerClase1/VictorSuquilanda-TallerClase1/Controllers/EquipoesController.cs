...
namespace VictorSuquilanda_TallerClase1.Controllers
{
    public class EquipoesController : Controller
    {
        private readonly VictorSuquilanda_TallerClase1Context _context;

        public EquipoesController(VictorSuquilanda_TallerClase1Context context)
        {
            _context = context;
        }
        ...
        {
            var victorSuquilanda_TallerClase1Context = _context.Equipo.Include(e => e.Estadio);
        ...
        {
            ViewData["IdEstadio"] = new SelectList(_context.Set<Estadio>(), "Id", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Ciudad,Titulos,AceptaExtranjeros,IdEstadio")] Equipo equipo)
        {
            ...
            ViewData["IdEstadio"] = new SelectList(_context.Set<Estadio>(), "Id", "Name", equipo.IdEstadio);
            return View(equipo);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Ciudad,Titulos,AceptaExtranjeros,IdEstadio")] Equipo equipo)
        {
            if (id != equipo.Id)
            {
                return NotFound();
